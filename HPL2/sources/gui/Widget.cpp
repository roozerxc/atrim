...
bool iWidget::ProcessMessage(eGuiMessage aMessage, const cGuiMessageData& aData, bool abSkipVisCheck, bool abSkipEnabledCheck)
{
    ...
    if(bRet==false)
    {
        ...
        case eGuiMessage_MouseMove:
            bRet = OnMouseMove(tData);
            break;
        case eGuiMessage_MouseDown:
            bRet = OnMouseDown(tData);
            break;
        case eGuiMessage_MouseUp:
            bRet = OnMouseUp(tData);
            break;
        case eGuiMessage_MouseDoubleClick:
            bRet = OnMouseDoubleClick(tData);
            break;
        case eGuiMessage_MouseEnter:
            bRet = OnMouseEnter(tData);
            break;
        case eGuiMessage_MouseLeave:
            bRet = OnMouseLeave(tData);
            break;
        case eGuiMessage_KeyPress:
            bRet = OnKeyPress(tData);
            break;
        case eGuiMessage_GotFocus:
            bRet = OnGotFocus(tData);
            break;
        case eGuiMessage_GotTabFocus:
            bRet = OnGotTabFocus(tData);
            break;
        case eGuiMessage_LostFocus:
            bRet = OnLostFocus(tData);
            break;
        case eGuiMessage_UIArrowPress:
            bRet = OnUIArrowPress(tData);
            break;
        case eGuiMessage_UIArrowRelease:
            bRet = OnUIArrowRelease(tData);
            break;
        case eGuiMessage_UIButtonPress:
            bRet = OnUIButtonPress(tData);
            break;
        case eGuiMessage_UIButtonDoublePress:
            bRet = OnUIButtonDoublePress(tData);
            break;
        case eGuiMessage_UIButtonRelease:
            bRet = OnUIButtonRelease(tData);
            break;
        case eGuiMessage_GetUINavFocus:
            bRet = OnGetUINavFocus(tData);
            break;
        case eGuiMessage_LoseUINavFocus:
            bRet = OnLoseUINavFocus(tData);
            break;
        }
    }
