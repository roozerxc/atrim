                           ...
                           eGpuShaderMatrixOp mOp)
{
    ...
    switch(mType)
    {
    case eGpuShaderMatrix_View:
        MtxType=CG_GL_MODELVIEW_MATRIX;
        break;
    case eGpuShaderMatrix_Projection:
        MtxType=CG_GL_PROJECTION_MATRIX;
        break;
    case eGpuShaderMatrix_Texture:
        MtxType=CG_GL_TEXTURE_MATRIX;
        break;
    case eGpuShaderMatrix_ViewProjection:
        MtxType=CG_GL_MODELVIEW_PROJECTION_MATRIX;
        break;
    }
    switch(mOp)
    {
    case eGpuShaderMatrixOp_Identity:
        OpType=CG_GL_MATRIX_IDENTITY;
        break;
    case eGpuShaderMatrixOp_Inverse:
        OpType=CG_GL_MATRIX_INVERSE;
        break;
    case eGpuShaderMatrixOp_Transpose:
        OpType=CG_GL_MATRIX_TRANSPOSE;
        break;
    case eGpuShaderMatrixOp_InverseTranspose:
