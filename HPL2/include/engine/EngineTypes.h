...
public:
    ...
    public:
        ...
        void SetVal(float afVal)
        {
            mfVal = afVal;
        }
        void SetTypes(tFlag aTypes)
        {
            mTypes = aTypes;
        }
        ...
        void SetDest(float afDest)
        {
            mfDest = afDest;
        }
        void SetDestroyAtDest(bool abX)
        {
            mbDestroyAtDest = abX;
        }
        ...
        bool GetDestroyAtDest()
        {
            return mbDestroyAtDest;
        }
