...
public:
    ...
    {
        mfMoveOppositeDirAccMul[aDir] = afX;
    }
    float GetMoveOppositeDirAccMul(eCharDir aDir)
    {
        return mfMoveOppositeDirAccMul[aDir];
    }


    void SetDeaccelerateMoveSpeedInAir(bool abX)
    {
        mbDeaccelerateMoveSpeedInAir = abX;
    }
    ...
    {
        mlMaxOnGroundCount = alX;
    }
    int GetMaxOnGroundCount()
    {
        return mlMaxOnGroundCount;
    }
    ...
    {
        mbDisableDiagSpeedBoost = abX;
    }
    bool GetDisableDiagSpeedBoost()
    {
        return mbDisableDiagSpeedBoost;
    }
    ...
    {
        return mbActive && mbMovedLastUpdate;
    }
    ...
    {
        mfMaxStepHeight = afSize;
    }

    float GetMaxStepSizeInAir()
    {
        return mfMaxStepHeightInAir;
    }
    void SetMaxStepSizeInAir(float afSize)
    {
        mfMaxStepHeightInAir = afSize;
    }

    void SetStepClimbSpeed(float afX)
    {
        mfStepClimbSpeed = afX;
    }
    ...
    {
        mbRotateYawWhenGravityAttached = abX;
    }
    bool GetRotateYawWhenGravityAttached()
    {
        return mbRotateYawWhenGravityAttached;
    }

    void SetGravityAttachedBody(iPhysicsBody* apBody)
    {
    ...
    void SetConnectionPosLocalToBody(const cVector3f& avPos)
    {
        mvConnectionPosLocalToBody = avPos;
    }
    void SetConnectionPosLocalToChar(const cVector3f& avPos)
    {
    ...
    void SetConnectionLocalUpBody(const cVector3f& avVec)
    {
        mvConnectionLocalUpBody = avVec;
    }

    void SetMaxConnectionForce(float afX)
    {
        mfMaxConnectionForce = afX;
    }
    void SetMaxConnectionTorque(float afX)
    {
        mfMaxConnectionTorque = afX;
    }
    float GetMaxConnectionForce()
    {
        return mfMaxConnectionForce;
    }
    float GetMaxConnectionTorque()
    {
        return mfMaxConnectionTorque;
    }
    ...
    {
        mbEntitySmoothYPos = abX;
    }
    void SetEntitySmoothYPosNum(int alX)
    {
        mlEntitySmoothYPosNum = alX;
    }
    bool GetUseEntitySmoothYPos()
    {
        return mbEntitySmoothYPos;
    }
    int GetEntitySmoothYPosNum()
    {
        return mlEntitySmoothYPosNum;
    }
