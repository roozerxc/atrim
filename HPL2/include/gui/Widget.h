...
public:
    ...
    {
        mbToolTipEnabled = abX;
    }
    bool IsToolTipEnabled()
    {
        return mbToolTipEnabled;
    }
    ...
    virtual void SetDefaultFontType(iFontData *apFont)
    {
    ...
    virtual void SetDefaultFontColor(const cColor& aColor)
    {
    ...
    virtual void SetDefaultFontSize(const cVector2f& avSize)
    {
        mvDefaultFontSize = avSize;
    }
    ...
    void SetColorMul(const cColor &aColor)
    {
        mColorMul = aColor;
    }
    ...
    {
        mbGlobalKeyPressListener = abX;
    }
    bool IsGlobalKeyPressListener()
    {
        return mbGlobalKeyPressListener;
    }
    ...
    {
        mbCallbacksDisabled = abX;
    }
    bool GetCallbacksDisabled()
    {
        return mbCallbacksDisabled;
    }
    ...
    {
        mbGlobalUIInputListener = abX;
    }
    bool IsGlobalUIInputListener()
    {
        return mbGlobalUIInputListener;
    }
...
protected:
    ...
    virtual bool OnMouseMove(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnMouseDown(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnMouseUp(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnMouseDoubleClick(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnMouseEnter(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnMouseLeave(const cGuiMessageData& aData)
    {
        return false;
    }
    ...
    virtual bool OnLostFocus(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual void OnChildLostFocus(iWidget* apChild, const cGuiMessageData& aData);

    virtual bool OnKeyPress(const cGuiMessageData& aData)
    {
        return false;
    }
    ...
    virtual bool OnUIArrowRelease(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnUIButtonPress(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnUIButtonRelease(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnUIButtonDoublePress(const cGuiMessageData& aData)
    {
        return false;
    }

    virtual bool OnGetUINavFocus(const cGuiMessageData& aData)
    {
        return false;
    }
    virtual bool OnLoseUINavFocus(const cGuiMessageData& aData)
    {
        return false;
    }
