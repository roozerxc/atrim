...
public:
    ...
    inline void SetParent(iRenderableContainerNode* apParent)
    {
        mpParent = apParent;
    }
    ...
    inline const cVector3f GetCenter() const
    {
        return mvCenter;
    }
    ...
    inline void SetViewDistance(float afX)
    {
        mfViewDistance = afX;
    }

    inline bool IsInsideView() const
    {
        return mbInsideView;
    }
    inline void SetInsideView(bool abX)
    {
        mbInsideView = abX;
    }

    inline bool UsesFlagsAndVisibility()
    {
        return mbUsesFlagsAndVisibility;
    }

    inline tRenderableFlag GetRenderFlags() const
    {
        return mlRenderFlags;
    }
    inline bool HasVisibleObjects() const
    {
        return mbVisibleObjects;
    }

    inline void SetRenderFlags(tRenderableFlag alFlags)
    {
        mlRenderFlags = alFlags;
    }
    inline void SetHasVisibleObjects(bool abX)
    {
        mbVisibleObjects = abX;
    }

    inline void SetNeedPropertyUpdate(bool abX)
    {
        mbNeedPropertyUpdate = abX;
    }
    inline bool GetNeedPropertyUpdate() const
    {
        return mbNeedPropertyUpdate;
    }

    void PushUpNeedAABBUpdate();
    inline bool GetNeedAABBUpdate() const
    {
        return mbNeedAABBUpdate;
    }

    inline void SetPrevFrustumCollision(eCollision aX)
    {
        mPrevFrustumCollision = aX;
    }
    inline eCollision GetPrevFrustumCollision() const
    {
        return mPrevFrustumCollision;
    }
