...
public:
    ...
    void SetMatrix(const cMatrixf& a_mtxTrans)
    {
...
public:
    ...
    void SetFilePath(const tWString& asFile)
    {
        msFilePath = asFile;
    }
    ...
    void SetIsSoundEmitter(bool abX)
    {
        mbIsSoundEmitter = abX;
    }
    bool IsSoundEmitter()
    {
    ...
    {
        return cLightListIterator(&mlstLights);
    }
    ...
    {
        return cParticleSystemIterator(&mlstParticleSystems);
    }
