...
public:
    ...
    static bool GetWasConnected(int alIndex)
    {
        return mbDeviceConnected[alIndex];
    }
    static void SetWasConnected(int alIndex, bool abVal)
    {
        mbDeviceConnected[alIndex] = abVal;
    }
private:
