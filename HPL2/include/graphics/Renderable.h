...
public:
    ...
    virtual bool UsesOcclusionQuery()
    {
        return false;
    }
    virtual void AssignOcclusionQuery(iRenderer *apRenderer) {}
    virtual bool RetrieveOcculsionQuery(iRenderer *apRenderer)
    {
        return true;
    }
    ...
    virtual void SetIlluminationAmount(float afX)
    {
    ...
    inline float GetCoverageAmount()const
    {
        return mfCoverageAmount;
    }

    void SetLargePlaneSurfacePlacement(int alX)
    {
        mlLargePlaneSurfacePlacement = alX;
    };
    inline int GetLargePlaneSurfacePlacement()
    {
        return mlLargePlaneSurfacePlacement;
    };
    ...
    inline float GetViewSpaceZ() const
    {
        return mfViewSpaceZ;
    }
    ...
    void SetRenderCallback(iRenderableCallback *apCallback)
    {
    ...
    inline void SetRenderContainerNode(iRenderableContainerNode* apNode)
    {
        mpRenderContainerNode = apNode;
    }

    void SetRenderableUserData(void* apData)
    {
