...
public:
    ...
    void SetFastloadMaterial(const tString& asFile)
    {
        msFastloadMaterial = asFile;
    }
    void SetUseFastloadMaterial(bool abX)
    {
    ...
    bool GetUseFastloadMaterial()
    {
        return mbUseFastloadMaterial;
    }
