...
public:
    ...
    {
        mbNormalizeAnimationWeights = abX;
    }
    bool GetNormalizeAnimationWeights()
    {
        return mbNormalizeAnimationWeights;
    }
    ...
    bool GetUpdateBonesWhenCulled()
    {
        return mbUpdateBonesWhenCulled;
    }
