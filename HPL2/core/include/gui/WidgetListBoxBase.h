...
public:
    ...
    void SetAllowMultiSelection(bool abX)
    {
        mbAllowMultiSelection = abX;
    }
    bool GetAllowMultiSelection()
    {
        return mbAllowMultiSelection;
    }
