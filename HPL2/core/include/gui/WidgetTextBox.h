...
public:
    ...
    {
        mbCallbackOnLostFocus = abX;
    }
    bool GetCallbackOnLostFocus()
    {
        return mbCallbackOnLostFocus;
    }
    ...
    static void SetDefaultDecimals(int alX)
    {
        mlDefaultDecimals = alX;
    }
    ...
    */
    ...
    {
        return mbLegalCharCodeLimitEnabled;
    }
    wchar_t GetLegalCharCodeMinLimit()
    {
        return mlLegalCharCodeMinLimit;
    }
    wchar_t GetLegalCharCodeMaxLimit()
    {
        return mlLegalCharCodeMaxLimit;
    }
