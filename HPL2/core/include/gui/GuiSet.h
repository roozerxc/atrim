...
public:
    ...
    bool RendersBeforePostEffects()
    {
        return mbRendersBeforePostEffects;
    }
    ...
    void SetToolTipWidget(iWidget* apWidget)
    {
        mpCurrentToolTipWidget = apWidget;
    }

    void SetWidgetsNeedSorting()
    {
        mbSortWidgets = true;
    }
    ...
    void SetDrawFocus(bool abX)
    {
        mbDrawFocus = abX;
    }
    void SetFocusDrawCallback(void* apObject, tGuiCallbackFunc apCallback)
    {
        mpFocusDrawObject = apObject;
        mpFocusDrawCallback = apCallback;
    }
