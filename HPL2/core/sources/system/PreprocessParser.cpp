...
bool cPreprocessParser::ParseSymbol(iParserSymbol *apSymbol)
{
    ...
    {
    case eParserSymbol_Text:
        return ParseText(apSymbol->ToText());
    case eParserSymbol_Variable:
        return ParseVariable(apSymbol->ToVariable());
    case eParserSymbol_Operator:
        return ParseOperator(apSymbol->ToOperator());
    case eParserSymbol_Keyword:
