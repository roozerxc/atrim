...
void cVtxBufferGLElementArray::Reserve(size_t alSize)
{
    ...
    {
    case eVertexBufferElementFormat_Float:
        mpFloatArray->reserve(alSize);
        break;
    case eVertexBufferElementFormat_Int:
        mpIntArray->reserve(alSize);
        break;
    case eVertexBufferElementFormat_Byte:
        mpByteArray->reserve(alSize);
        break;
    }
}
void cVtxBufferGLElementArray::Resize(size_t alSize)
{
    ...
    {
    case eVertexBufferElementFormat_Float:
        mpFloatArray->resize(alSize);
        break;
    case eVertexBufferElementFormat_Int:
        mpIntArray->resize(alSize);
        break;
    case eVertexBufferElementFormat_Byte:
        mpByteArray->resize(alSize);
        break;
    }
}
void cVtxBufferGLElementArray::PushBack(const void *apData)
{
    ...
    {
    case eVertexBufferElementFormat_Float:
        mpFloatArray->push_back( *((const float*)apData) );
        break;
    case eVertexBufferElementFormat_Int:
        mpIntArray->push_back( *((const int*)apData) );
        break;
    case eVertexBufferElementFormat_Byte:
        mpByteArray->push_back( *((const unsigned char*)apData) );
        break;
    }
}
...
void* cVtxBufferGLElementArray::GetArrayPtr()
{
    ...
    {
    case eVertexBufferElementFormat_Float:
        return &(*mpFloatArray)[0];
    case eVertexBufferElementFormat_Int:
        return &(*mpIntArray)[0];
    case eVertexBufferElementFormat_Byte:
        return &(*mpByteArray)[0];
    }
    return NULL;
}
...
size_t cVtxBufferGLElementArray::Size()
{
    ...
    {
    case eVertexBufferElementFormat_Float:
        return mpFloatArray->size();
    case eVertexBufferElementFormat_Int:
        return mpIntArray->size();
    case eVertexBufferElementFormat_Byte:
        return mpByteArray->size();
    }
    return 0;
}
