...
bool cGuiSet::SendMessage(eGuiMessage aMessage, const cGuiMessageData& aData)
{
    ...
    case eGuiMessage_UIArrowRelease:
        return OnUIArrowRelease(aData);
    case eGuiMessage_UIButtonPress:
        return OnUIButtonPress(aData);
    case eGuiMessage_UIButtonRelease:
        return OnUIButtonRelease(aData);
    case eGuiMessage_UIButtonDoublePress:
        return OnUIButtonDoublePress(aData);
    }
...
eUIArrow cGuiSet::TranslateKeyToUIArrow(eKey aKey)
{
    ...
    case eKey_Up:
        return eUIArrow_Up;
    case eKey_Right:
        return eUIArrow_Right;
    case eKey_Down:
        return eUIArrow_Down;
    case eKey_Left:
        return eUIArrow_Left;
    default:
        return eUIArrow_LastEnum;
    }
}
