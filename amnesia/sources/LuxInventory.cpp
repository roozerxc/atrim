...
void cLuxInventory::RemoveItem(const tString& asName)
{
    ...
    for(; it != mvItems.end(); ++it)
    {
        ...
        {
            if(mpPickedItem == pItem)
            {
                mpPickedItem = NULL;
            }
            if(mpEquippedItem == pItem)
            {
                mpEquippedItem = NULL;
            }
...
void cLuxInventory::RemoveItem(cLuxInventory_Item *apItem)
{
    ...
    if(mpPickedItem == apItem)
    {
        mpPickedItem = NULL;
    }
    if(mpEquippedItem == apItem)
    {
        mpEquippedItem = NULL;
    }
...
bool cLuxInventory::UIButtonPress(iWidget* apWidget, const cGuiMessageData& aData)
{
    ...
    case eUIButton_NextPage:
        ...
        case 1:
        case 2:
            SetCurrentWidget(mpTinderboxWidget);
            return true;
        case 3:
            SetCurrentWidget(mpOilWidget);
            return true;
        case 4:
            SetCurrentWidget(mpJournalWidget);
            return true;
        default:
            SetCurrentWidget(mpTinderboxWidget);
            return true;
    ...
    case eUIButton_PrevPage:
        ...
        {
        case 2:
            SetCurrentWidget(mpSanityWidget);
            return true;
        case 3:
        case 4:
        case 5:
            SetCurrentWidget(mpHealthWidget);
            return true;
        default:
            SetCurrentWidget(mpHealthWidget);
            return true;
