...
void main()
{
    vec4 vColorVal = pow(texture2DRect(aDiffuseMap, gl_FragCoord.xy), vec4(2.2, vec3(2.4, 1.9, 0.1)) * 1.125);
    ...
    gl_FragColor.xyz = pow(vColorVal.xyz * avLightColor.xyz, vec3(1.0 / 1.6)) * fAttenuation;
}
